...
from trigger_workflow_formal_document_writer.openhands_runner import (
...
from trigger_workflow_formal_document_writer.runner_utils import (
    RunnerTargetContext,
    ensure_git_branch,
...
class OpenHandsRunnerTests(unittest.TestCase):
    ...
    @patch(
        "trigger_workflow_formal_document_writer.openhands_runner.openhands_env",
    ...
    def test_resolve_openhands_model_connection_errors_on_invalid_config_json(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            with patch("trigger_workflow_formal_document_writer.openhands_runner.WORKSPACE", workspace):
    ...
    def test_load_session_state_errors_on_invalid_json(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            with patch("trigger_workflow_formal_document_writer.openhands_runner.SESSION_STATE_PATH", session_state_path):
                with self.assertRaises(SystemExit) as exc:
                    load_session_state()
    ...
    @patch("trigger_workflow_formal_document_writer.runner_utils.current_branch", return_value="main")
    @patch("trigger_workflow_formal_document_writer.runner_utils.branch_exists", return_value=False)
    ...
    @patch("trigger_workflow_formal_document_writer.runner_utils.git_run")
    @patch("trigger_workflow_formal_document_writer.runner_utils.ensure_git_branch")
    @patch("trigger_workflow_formal_document_writer.runner_utils.branch_exists")
    @patch("trigger_workflow_formal_document_writer.openhands_runner.prepare_target_repo_checkout")
    @patch("trigger_workflow_formal_document_writer.runner_utils.resolve_target_repo_config")
    ...
    @patch("trigger_workflow_formal_document_writer.runner_utils.log_info")
    @patch("trigger_workflow_formal_document_writer.runner_utils.ensure_managed_repo_checkout")
    @patch("trigger_workflow_formal_document_writer.runner_utils.current_branch", return_value="issue/21")
    @patch("trigger_workflow_formal_document_writer.runner_utils.ensure_git_branch")
    @patch("trigger_workflow_formal_document_writer.runner_utils.resolve_phase_execution_branch", return_value="issue/21")
    @patch("trigger_workflow_formal_document_writer.runner_utils.resolve_target_repo_config")
    ...
    @patch("trigger_workflow_formal_document_writer.runner_utils.ensure_managed_repo_checkout")
    @patch("trigger_workflow_formal_document_writer.runner_utils.current_branch", side_effect=["main", "main"])
    @patch("trigger_workflow_formal_document_writer.runner_utils.ensure_git_branch")
    @patch("trigger_workflow_formal_document_writer.runner_utils.resolve_phase_execution_branch", return_value="issue/21")
    @patch("trigger_workflow_formal_document_writer.runner_utils.resolve_target_repo_config")
    ...
    @patch("trigger_workflow_formal_document_writer.openhands_runner.prepare_phase_execution_context")
    @patch("trigger_workflow_formal_document_writer.openhands_runner._run_openhands_command")
    ...
    @patch("trigger_workflow_formal_document_writer.runner_utils.prepare_phase_execution_context")
    @patch("trigger_workflow_formal_document_writer.runner_utils.subprocess.run")
    ...
    @patch("trigger_workflow_formal_document_writer.openhands_runner.save_session_state")
    @patch("trigger_workflow_formal_document_writer.openhands_runner.prepare_phase_execution_context")
    @patch("trigger_workflow_formal_document_writer.openhands_runner._run_openhands_command")
    ...
    @patch("trigger_workflow_formal_document_writer.openhands_runner.run_phase_tests")
    @patch("trigger_workflow_formal_document_writer.openhands_runner.run_openhands")
