...
from trigger_workflow_formal_document_writer.runner_utils import resolve_phase_execution_branch
...
from trigger_workflow_formal_document_writer.router import conversation_scope_for_phase
...
class PromptBuilderTests(unittest.TestCase):
    ...
    def test_phase_1_prompt_enforces_evaluation_criteria(self) -> None:
    ...
    @patch("trigger_workflow_formal_document_writer.prompts.BASE_PERSONA_FILE", "missing-daneel.md")
    ...
    @patch.dict("trigger_workflow_formal_document_writer.prompts.PERSONA_FILE_MAP", {"2B": "missing-phase-persona.md"}, clear=False)
    ...
    @patch.dict(
        "trigger_workflow_formal_document_writer.prompts.FUNCTIONAL_MICROAGENT_FILE_MAP",
