...
class GitHubOpsTests(unittest.TestCase):
    ...
    @patch("trigger_workflow_creative_writer.github_ops.fetch_parent_sub_issue_ids", return_value={1001, 1002, 1003})
    @patch("trigger_workflow_creative_writer.github_ops.add_blocked_by_dependency")
    @patch("trigger_workflow_creative_writer.github_ops.add_sub_issue_relationship")
    @patch("trigger_workflow_creative_writer.github_ops.create_issue_via_api")
