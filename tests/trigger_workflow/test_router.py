...
class RouterPhaseExecutionTests(unittest.TestCase):
    ...
    @patch("trigger_workflow.core.advance_issue_label")
    @patch("trigger_workflow.core.post_issue_comment")
    @patch("trigger_workflow.core.log_multiline")
    @patch("trigger_workflow.core.run_comment_phase", return_value="Line one\nLine two")
    ...
    @patch("trigger_workflow.core.post_issue_comment")
    @patch("trigger_workflow.core.clear_issue_labels_except")
    @patch("trigger_workflow.core.create_issue_branches_for_child_issues")
    @patch("trigger_workflow.core.log_multiline")
    @patch("trigger_workflow.core.build_phase_four_summary", return_value="Summary body")
    @patch(
        "trigger_workflow.core.create_child_issues",
        return_value=[{"number": 101, "id": 1001, "title": "child", "url": "https://example.com/101"}],
    )
    @patch("trigger_workflow.core.validate_tiferet_specification_payload_structure")
    @patch(
        "trigger_workflow.core.run_json_phase",
    ...
    @patch("trigger_workflow.core.advance_issue_label")
    @patch("trigger_workflow.core.post_issue_comment")
    @patch("trigger_workflow.core.finalize_delivery", return_value="Delivery summary")
    @patch("trigger_workflow.core.run_implementation_phase")
    ...
    @patch("trigger_workflow.core.execute_implementation_phase_task")
    @patch("trigger_workflow.core.execute_tiferet_specification_phase")
    @patch("trigger_workflow.core.execute_comment_phase_handoff")
    @patch("trigger_workflow.core.fetch_issue_data")
    @patch("trigger_workflow.core.read_microagent_for_label")
    @patch("trigger_workflow.core.ensure_phase_labels")
    ...
    @patch("trigger_workflow.core.log_error")
    @patch("trigger_workflow.core.tag_issue_needs_human")
    @patch("trigger_workflow.core.execute_tiferet_specification_phase", side_effect=SystemExit("phase failed"))
    @patch("trigger_workflow.core.fetch_issue_data")
    @patch("trigger_workflow.core.read_microagent_for_label")
    @patch("trigger_workflow.core.ensure_phase_labels")
    ...
    @patch("trigger_workflow.core.preview_phase_execution_plan")
    @patch("trigger_workflow.core.execute_implementation_phase_task")
    @patch("trigger_workflow.core.execute_tiferet_specification_phase")
    @patch("trigger_workflow.core.execute_comment_phase_handoff")
    @patch("trigger_workflow.core.fetch_issue_data")
    ...
    @patch("trigger_workflow.core.log_multiline")
    @patch("trigger_workflow.core.log_info")
    @patch("trigger_workflow.core.build_phase_execution_prompt", return_value=("PROMPT-CONTENT", ""))
