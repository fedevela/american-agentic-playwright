...
2. Prepare the spatial and temporal architecture that gives characters room to perform.
...
7. Mark open physical opportunities using `<ACTION focus="..." intent="...">`.
...
- Describe environmental conditions in `<ACTION>` tags; use neutral placeholders for character contributions.
- Reserve character delivery with neutral placeholders in self-closing `<PARENTHETICAL character="..." action="..." />` tags.
