...
def build_comment_phase_prompt(
    ...
    requirements = [
        ...
        "- CRITICAL LANGUAGE MANDATE: You must write your response and all artifacts in the same language as the original issue text.",
    ]
...
- Do not mention tool limitations, environment limitations, or inability to post.
- CRITICAL LANGUAGE MANDATE: You must write your response, sub-issue titles, and bodies in the same language as the original issue text.
"""
...
def build_implementation_phase_prompt(
    ...
    terminal_discipline_requirements = [
        "- CRITICAL LANGUAGE MANDATE: You must write all content, analysis, and artifacts in the same language as the original issue text.",
