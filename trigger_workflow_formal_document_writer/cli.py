...
def run_trigger_cli(mode: str = "formal-document-writer") -> None:
    """Main entry point."""
    ...
    parser.add_argument("--mode", type=str, choices=["sdlc", "formal-document-writer"], default=mode, help="The operating mode of the swarm")
    ...
    if config.RUNNER_TYPE == "openhands":
        sys.exit("Error: The 'formal-document-writer' mode currently only supports the 'gemini' runner.")
